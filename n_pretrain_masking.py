...
def train(args, model_list, loader, optimizer_list, device):
    ...
    for step, batch in enumerate(tqdm(loader, desc="Iteration")):
        ...
        node_rep,_ = model(batch.x, batch.edge_index, batch.edge_attr)
        ...
        batch.masked_edge_idx=batch.masked_edge_idx.type(torch.long)
...
def main():
    ...
    parser.add_argument('--model_file', type=str, default = 'param_yuanmodel_masking_1', help='filename to output the model')
