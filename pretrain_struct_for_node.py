...
from model_ns import GNN_structpred_node
...
def main():
    ...
    parser.add_argument('--output_model_file', type=str, default='param_struct_1',
    ...
    # set up model
    model = GNN_structpred_node(args.num_layer, args.emb_dim, JK=args.JK, drop_ratio=args.dropout_ratio,
