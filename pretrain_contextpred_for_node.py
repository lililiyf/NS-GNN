...
def train(args, model_substruct, model_context, loader, optimizer_substruct, optimizer_context, device):
    ...
    for step, batch in enumerate(tqdm(loader, desc="Iteration")):
        ...
        substruct_rep, _ = model_substruct(batch.x_substruct, batch.edge_index_substruct, batch.edge_attr_substruct)
        substruct_rep = substruct_rep[batch.center_substruct_idx]

        ### creating context representations
        overlapped_node_rep, _ = model_context(batch.x_context, batch.edge_index_context, batch.edge_attr_context)
