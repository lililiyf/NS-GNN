...
def train(args, model_list, loader, optimizer_list, device):
    ...
    for step, batch in enumerate(tqdm(loader, desc="Iteration")):
        ...
        _,node_rep = model(batch.x, batch.edge_index, batch.edge_attr)
...
def main():
    ...
    parser.add_argument('--model_file', type=str, default = 'param_struct_masking_1', help='filename to output the model')
