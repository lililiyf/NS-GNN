...
def train(args, model, device, loader, optimizer):
    ...
    for step, batch in enumerate(tqdm(loader, desc="Iteration")):
        ...
        pred = model(batch) # model = GNN_graphpred(args.num_layer, args.emb_dim, num_tasks, JK = args.JK, drop_ratio = args.dropout_ratio, graph_pooling = args.graph_pooling, gnn_type = args.gnn_type)
...
def main():
    ...
    parser.add_argument('--model_file', type=str, default = 'param_masking_masking_1.pth', help='filename to read the model (if there is any)')
    parser.add_argument('--filename', type=str, default = 'param_masking_masking_1', help='output filename')
    ...
    if args.split == "random":
        ...
        trainval_dataset, test_dataset = species_split(dataset)# trainval 7种    test 1种
