...
from model import GNN_structpred
...
def main():
    ...
    #set up model
    model = GNN_structpred(args.num_layer, args.emb_dim, args.cluster_number, JK = args.JK, drop_ratio = args.dropout_ratio, gnn_type = args.gnn_type)
